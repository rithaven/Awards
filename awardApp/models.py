...
class Profile(models.Model):
      ...
      profile_pic = models.ImageField(upload_to='photos/', null=True, blank=True, default=0)
      ...
      def search_users(cls,search_term):
          profiles = cls.objects.filter(user_username_icontains=search_term)
          return profiles
      @property
      def image_url(self):
...
class Image(models.Model):
      ...
      def search_image(cls,search_term):
          pictures=cls.objects.filter(imag_location=search_term)
          return pictures
      @classmethod
